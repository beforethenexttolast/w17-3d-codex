...
| **DRV-ESC-CURRENT** | **44.2×33.7×34.0 mm**, 100 g loose; installed height includes the fan + finned-heatsink stack. Superseded documented figure: **44.2×37×24.2 mm**; 24.2 mm excludes that cooling stack | VERIFIED — 2026-07-24 owner-present no-power caliper/scale session (`../w17-batch1-measurements-for-codex.md`) | current floor station is **FAIL-STATION** pending re-derivation; retains the documented delta and prior provisional study result as history |
