...
| VID-WIFI | Z3R-L1 deck rear slot (airbox draft) | flat, pigtails fwd | PS-04 pocket (P9 **dummy**, RST-06) | USB pad edge: not recorded (the 2026-07-18 "fwd" belonged to the same pre-measurement guess as "U.FL aft" and has no measured source; [`Z_wire_schedule.csv`:42-43](Z_wire_schedule.csv) carry it as UNPLACED — the owner's photo/label packet item 7 / proposed row M-31 records it); U.FL fwd at the X+1 module edge, turning outward — corrected 2026-09-06 to match the measured placement ([`fit_studies/ZK_electronics_cassette_fit_study.md:103`](fit_studies/ZK_electronics_cassette_fit_study.md), restated [`AA_electronics_placement_study.md:154`](AA_electronics_placement_study.md)) | H-07/H-10 | P | **possession + D-06b**, D-02 |
